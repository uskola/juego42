...
/*   Updated: 2023/09/21 14:57:07 by auskola-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_map_chars(t_data *data)
{
	...
	sum -= counter;
	counter = check_char(data, ENEMY_KEY);
	sum -= counter;
	if (sum != 0)
...
./so_long_bonus \"maps/ghosts_bonus.ber\"\n./so_long_bonus\
 \"maps/island_bonus.ber\"\n");
	}
	if (argc > 2)
